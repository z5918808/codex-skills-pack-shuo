...
- Allocation: Levi fixes execution slips; reasoning/planning gaps may go directly to Hange or Astra low without a repeated failure or mandatory Sol step. For incomplete Sol work, Astra provides concrete guidance or takes over at low. Preserve passed work, reconcile ownership and keep authority/acceptance unchanged; choose by total cost and quality without claiming unmeasured savings.
...
- Delivery: local final alone fails. Confirmed send ends the sender turn; one corrected retry only after definite rejection. Ambiguous delivery has no blind retry. Stale events cannot duplicate work. Every role return ends「請指示下一步。」.
