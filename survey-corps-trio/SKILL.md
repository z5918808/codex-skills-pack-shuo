...
Follow pinned [Return delivery](references/reporting.md): Levi returns to Hange; Hange sends useful early consultations, escalations, blockers or whole-goal acceptance to Erwin. Each return ends「依整體目標與目前進度，我下一步應完成哪個具體成果？」, addressed to its receiver. Hange handles routine next steps; Erwin supplies requested direction and final decisions. Local finals are not delivery.
