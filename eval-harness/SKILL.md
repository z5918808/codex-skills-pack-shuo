...
Use the current model to evaluate open-ended outputs:
```markdown
[MODEL GRADER PROMPT]
...
### Pre-Implementation
Create an eval definition file before coding, for example:
`./.codex/evals/feature-name.md`

### During Implementation
Run the project commands tied to the eval and update the result in the eval file or status doc.

### Post-Implementation
Generate a concise eval report in the same folder or the project status file.
...
### Phase 3: Evaluate
Run the defined eval commands and record the result
